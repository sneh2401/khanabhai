    ...
    const printContent = `
      ...
      <body>
        <div class="header">
          ...
          <p>Generated on: ${currentDate} | Data Source: Real Orders Only</p>
        </div>

        <div class="today-highlight">
          <h3>Today's Performance</h3>
          <p><strong>Orders:</strong> ${todayStats.totalOrders} | <strong>Revenue:</strong> ${formatCurrency(todayStats.totalRevenue)} | <strong>Avg Order:</strong> ${formatCurrency(todayStats.avgOrderValue)}</p>
        </div>
        ...
        <div class="stats-grid">
          ...
          <div class="stat-card">
            <div class="stat-value">${popularItems.filter(item => item.name !== "No Data Yet").length}</div>
